...
def react_given_out_param(current_background, current_character, out_params):
    if out_params[0]:
        current_character.move((0, -64), current_background)
    elif out_params[1]:
        current_character.move((0, 64), current_background)
    elif out_params[2]:
...
while not done:
    ...
    for current_character in game_mode.characters:
        ...
        react_given_out_param(current_background, current_character, out_params)
